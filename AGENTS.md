...
This creates `imvideo/x.y.z`, builds and runs the tests when the target platform is runnable, and verifies that the package installs correctly. To build and run the repository test targets directly:
